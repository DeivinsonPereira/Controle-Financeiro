package com.projeto.controlefinanceiro.controllers.exceptions;
...
public class ControllerExceptionHandler {
	...
	public ResponseEntity<StandardError> errorDatabase(DatabaseException e, HttpServletRequest request){
